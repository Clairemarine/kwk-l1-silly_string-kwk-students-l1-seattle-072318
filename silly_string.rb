...
puts "My favorite word is bonjour"
...
bigger_word = big_word.length + smaller_word.length + small_word.length# Use String concatenation to add "wow" and "mom" to big_word

new_letter_count = bigger_word.size

string_word = big_word + smaller_word + small_word


puts "There are now #{bigger_word} in #{string_word}"
